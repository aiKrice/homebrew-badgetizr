...
![Static Badge](https://img.shields.io/badge/1.5.3-darkgreen?logo=homebrew&logoColor=white&label=Homebrew-tap)
[![Static Badge](https://img.shields.io/badge/1.5.3-grey?logo=github&logoColor=white&label=Github-Action&labelColor=black)](https://github.com/marketplace/actions/badgetizr)
...
jobs:
  badgetizr:
    ...
    steps:
      ...
      - name: Run Badgetizr
        uses: aiKrice/homebrew-badgetizr@1.5.3
        with:
